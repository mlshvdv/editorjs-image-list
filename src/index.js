...
export default class ImageListTool {
    ...
    save() {
        ...
        const imageContainers = this.ui.nodes.wrapper.querySelectorAll(`.${this.ui.CSS.imageContainer}[data-uploading='0']`);
        this._data.items = [];
    ...
    uploadingFailed(errorText) {
        this.api.notifier.show({
            message: this.api.i18n.t('Couldn’t upload image. Please try another: '+ errorText),
            style: 'error',
        });
